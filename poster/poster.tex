  ...
  \begin{columns}[t]
    ...
    \begin{column}{0.32\textwidth}
      ...
      \pbox{Additional Explorations}{
        ...
        Testing the ability to reproduce graphic assets like brand logos across novel contexts --- product mockups, merchandise, etc. Key differences: sharp edges, flat colors, and precise geometry. Exact graphic fidelity $>$ perceptual identity.
      ...
      \pbox{Future Work}{
        \begin{citemize}
          ...
          \item \textbf{Scale to 30 subjects:} Enables direct comparison with the paper's SD~1.5 baseline.
